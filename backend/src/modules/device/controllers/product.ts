...
export class ProductController {
  ...
  async syncProduct(req: Request, res: Response) {
    try {
      ...
      logger.info('Product ready for syncing...','Tenant ID => ',tenantId);
  ...
  async syncProductUpdate(req: Request, res: Response) {
    try {
        ...
        logger.info('Product ready for Product updated data...','Product ID => ',tenantId);
  ...
  async syncProductUpdateByUpc(req: Request, res: Response) {
    try {
        ...
        const params = {upc}
        logger.info('Product updated data ready for syncing...','Product ID => ',tenantId);
