...
import {seedScanMultipleSM} from "./20230201061022-scanMultipleSM"
import {seedNodeMappingScanMultiple} from "./202301020710299-nodeMappingScanMultiple"
...
export const seedMongoDbData = async () => {
  ...
  //  seedNodeMappingChange()
    ...
    await seedNodeMappingScanMultiple()
