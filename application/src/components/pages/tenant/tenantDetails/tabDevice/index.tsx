...
import { page, Tabs, Status } from "../../../../../config/constants";
...
export const DeviceList = (props: any) => {
  ...
  const { data, isSuccess, refetch, isError, fulfilledTimeStamp } = useGetAllDevicesQuery(queryParams, {
  ...
  }, [data, isSuccess,fulfilledTimeStamp]);
  useEffect(() => {
    if (isError) {
      setLoading(false);
      setLoader(false)
