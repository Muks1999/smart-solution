...
import { page, Tabs } from "../../../../../config/constants";
...
export const ZoneList = (props: any) => {
  const { search, tenantId, isTenantActive, pagination, setPagination, selectedTab } = props;
  ...
  //API
  const { data, isSuccess, refetch, isError, fulfilledTimeStamp } = useGetAllZonesQuery(queryParams);
